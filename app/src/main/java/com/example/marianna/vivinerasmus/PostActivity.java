...
public class PostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textTitle = (EditText)findViewById(R.id.textTitolo);
 ...
 final String TitoloPost = textTitle.getText().toString().trim();
 final String DescPost = textDesc.getText().toString().trim();
